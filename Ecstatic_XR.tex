...
\setlength{\fboxsep}{0pt}%
\setlength{\fboxrule}{1.5pt}%
\fbox{\includegraphics[width=\linewidth]{med_head.png}}%
}%
...
\begin{enumerate}
	\item Ineffability: Inexplicable, defying expression and language. Requires direct experience.
	\item Noetic quality: True and deep insight; revelation; full of significance; durable
	\item Transiency: Fleeting in duration; difficult to recall in detail, but recognizable in subsequent revelation
	\item Passivity: The mystical state may be established voluntarily, but once it begins, the mystic is held beyond volition
\end{enumerate} 
}
