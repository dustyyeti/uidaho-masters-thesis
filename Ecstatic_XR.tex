...
\begin{acronym}[MAPS]  % Passing an acronym as argument makes other acronyms align with it. This is usually the longest acronym.
	\acro{AI}[{\textup{AI}}]{Artificial Intelligence}
	...
	\acro{CIIS}[{\textup{CIIS}}]{California Institute of Integral Studies}
	...
	\acro{MAPS}[{\textup{MAPS}}]{Multidisciplinary Association for Psychedelic Studies}
	\acro{MR}[{\textup{MR}}]{Mixed Reality}
	\acro{SI}[{\textup{SI}}]{Synthetic Intelligence}	
...
\epigraph {let thy food be thy medicine and thy medicine be thy food}
...
\chapter{Building Reality}
	%\caption[hello]{voyager} %? works but adds 'Figure' to the doc
	%\caption*{} %suppresses 'Figure'
